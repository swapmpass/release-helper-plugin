...
public class IssueUpdateBuilder {
     ...
     *
     * @param versionName the name of the version to add.
     */
     ...
     *
     * @param body the body of the comment to add.
     */
     ...
     * @return the json object representing a reference to this element
     */
