...
public class JIRAAccessTool {
     ...
     * @param buildingLambda buildingLambda the lambda providing the information about the new version
     ...
     *
     * @param versionName the name of the version to look for (e.g. 1.0)
     * @return an instance representing the given version or null if no such version exists.
     */
     ...
     *
     * @param jqlQuery the query to filter for
     * @return a list of all issues with this version as affected version.
     */
     ...
     *
     * @param issuesToShow the issues to list on the html page
     ...
     *
     * @param buildingFunction the lambda providing the information of the new ticket.
     * @param type             the issue type (e.g. Task, bug, etc)
     ...
     *
     * @param typeName the name of the type to scan for, e.g. task, bug, etc
     * @return an IssueType instance representing the given issue type.
     */
     ...
     *
     * @param priorityName the name of the priority to scan for, e.g. high, medium, etc
     * @return an BasicPriority instance representing the given issue priority.
     */
     ...
     *
     * @param ticketKey the key of the issue to fetch.
     ...
     *
     * @param issue the issue whose transitions shall be fetched.
     ...
     *
     * @param issue      the issue on which the transition shall be performed.
     * @param transition the transition to be performed
     */
    ...
    public interface BuildingLambda<B> {
         ...
         *
         * @param builder the issue builder used to build the ticket
         */
