...
public abstract class TicketModification extends AbstractDescribableImpl<TicketModification> {
     ...
     *
     * @param ticketKey   the key of the ticket to update
     * @param jira        the jira access tool which may be used to perform the update
     * @param varReplacer the variable replacer for parameters
     * @param logger      the logger of the build process
     */
