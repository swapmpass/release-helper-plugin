...
public final class JIRAMetadataCache {
     ...
     *
     * @param credentialsID the id of the credentials of the JIRA project.
     ...
     *
     * @param credentialsID the id of the credentials of the JIRA project.
     * @return a list with the names of the statuses.
     */
     ...
     *
     * @param credentialsID the id of the credentials of the JIRA project.
     * @return a list with the names of the priorities.
     */
     ...
     *
     * @param credentialsID the id of the credentials of the JIRA project.
     * @return a list with the names of the versions.
     */
     ...
     * @param credentialsID the ID of the credentials to access JIRA.
     * @param commands      the commands to execute
     * @return the result of the commands or null if the execution was not successful.
     */
