...
public class JIRAProjectCredentials extends BaseStandardCredentials implements StandardCredentials {
     ...
     *
     * @param id the id of the credentials to query
     * @return the obejct representing these credentials or null, if is not a valid id.
     */
    ...
    public static class DescriptorImpl extends BaseStandardCredentialsDescriptor {
         ...
         * @return null if the data is allright, an error message otherwise.
         */
    ...
    public static class NameProvider extends CredentialsNameProvider<JIRAProjectCredentials> {
        ...
        @Override
        public String getName (JIRAProjectCredentials c) {
