...
public class JsonHTTPClientWrapper {
     ...
     *
     * @param path    the path (relative to the url) to issue the request on
     * @param element the put-data
     * @return null if the resposne was empty, an JSonElement representing the parsed response otherwise
     */
     ...
     *
     * @param path    the path (relative to the url) to issue the request on
     * @param element the post-data
     * @return null if the response was empty, an JSonElement representing the parsed response otherwise
     */
     ...
     *
     * @param path       the path (relative to the url) to issue the request on
     * @param parameters a map where the keys are paramternames and the values are the values.
     * @return null if the response was empty, an JSonElement representing the parsed response otherwise
     */
